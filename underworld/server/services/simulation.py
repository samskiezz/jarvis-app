    ...
    *,
    ...
    for _ in range(ticks):
        ...
        if world.tick % 5 == 0:
            ...
            # Government + legal institutions emerge / reform (doc I.41-42).
            await governance.tick_governance(session, world)
        ...
        # 3g6f3. Electrical grid — Joule-heating fires when the grid is under-built (#42).
        await grid.tick_grid(session, world, rng)
