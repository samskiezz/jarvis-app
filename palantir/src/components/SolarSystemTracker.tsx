 ...
 * (server/services/discovery_astro.py) onto the Osiris surface via the fail-safe
 * proxy /api/jarvis/astro. Themed to match the dark/gold Osiris panels.
 *
 ...
 *   • NEO close-approach checker — orbit (a, e) → earth-crossing + hazardous +
 *     lunar distances, computed by the same two-body Keplerian screen real NEO
 *     surveys use.
 */
...
export default function SolarSystemTracker({ onClose }: SolarSystemTrackerProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute inset-x-4 top-20 bottom-20 md:inset-x-auto md:right-20 md:left-auto md:w-[640px] z-[400] flex flex-col glass-panel overflow-hidden"
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--gold-primary)]/20 shrink-0">
        <div className="flex items-center gap-2">
          <Satellite className="w-4 h-4 text-[var(--cyan-primary)]" />
        ...
        <button
          onClick={onClose}
          aria-label="Close solar system tracker"
