...
const getLayerGroups = (theme: 'core' | 'ghost') => {
  ...
  {
    label: 'JARVIS',
    fullLabel: 'JARVIS PALANTIR ONTOLOGY',
    color: '#00E5FF',
    layers: [
      { key: 'jarvis_wildlife', label: 'Wildlife / Species', icon: Activity, color: '#00E676', dataKey: 'jarvis_wildlife' },
      { key: 'jarvis_sensors', label: 'Sensors', icon: Radio, color: '#00E5FF', dataKey: 'jarvis_sensors' },
      { key: 'jarvis_measure', label: 'Measurements', icon: Target, color: '#FFB300', dataKey: 'jarvis_measure' },
      { key: 'jarvis_places', label: 'Places', icon: Mountain, color: '#B388FF', dataKey: 'jarvis_places' },
      { key: 'jarvis_assets', label: 'Assets / Other', icon: Network, color: '#D4AF37', dataKey: 'jarvis_assets' },
    ],
  },
  {
    label: 'OCEAN',
    fullLabel: 'OCEAN / BUOYS',
    color: '#26C6DA',
    layers: [
  ...
  },
  {
    ...
    layers: [
      ...
      { key: 'fireballs', label: 'Fireballs', icon: Flame, color: '#FFD400', dataKey: 'fireballs' },
    ],
  },
  {
    label: 'SURVEIL',
