...
def _execute_connector(*args, **kwargs):
    source_id = kwargs.pop("source_id", "ftp_s3_bulk")
    url = kwargs.pop("url", kwargs.pop("endpoint", kwargs.pop("base_url", "")))
    return generic_connector("ftp_s3_bulk", source_id=source_id, url=url, **kwargs)

def run(*args, **kwargs):
    return _execute_connector(*args, **kwargs)

def parse(*args, **kwargs):
    return to_envelope(_execute_connector(*args, **kwargs), record_type="ftp_s3_bulk_connector_result")
