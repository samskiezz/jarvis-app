...
def parse(raw=None, source_id="emissions_facility"):
    return parse_by_name("emissions_facility_parser", raw or {}, source_id)
...
def run(raw=None, source_id="emissions_facility"):
