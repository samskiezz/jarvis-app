...
def parse(raw=None, source_id="beneficial_ownership"):
    return parse_by_name("beneficial_ownership_parser", raw or {}, source_id)
...
def run(raw=None, source_id="beneficial_ownership"):
