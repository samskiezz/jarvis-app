...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-13: Wired JarvisCommandPalette (scenes+panels+ASK, isApex guard) replacing simpler cinematic/CommandPalette in App.jsx]
