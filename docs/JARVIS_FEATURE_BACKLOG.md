...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-21: upgraded App.jsx to mount JarvisCommandPalette (10 scenes + 25 panel commands + Ask fallback) replacing the scenes-only stub]
