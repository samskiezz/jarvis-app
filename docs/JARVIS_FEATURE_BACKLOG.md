...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-08-24] Extended CommandPalette.jsx with 50 JARVIS action commands (group JARVIS) dispatching jarvis:ask events in addition to scene/page navigation; ⌘K/Ctrl+K, arrows, Enter, Esc all work.
