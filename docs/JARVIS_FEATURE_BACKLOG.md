...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-23: CommandPalette.jsx implemented — ⌘K/Ctrl+K opens searchable list of all JARVIS pages + 10 cinematic scenes with arrow-key nav + Enter to navigate; mounted in App.jsx; build verified.)
