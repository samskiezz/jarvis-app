...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [already implemented in src/components/cinematic/CommandPalette.jsx, mounted App.jsx:215; backlog not updated at time]
...
- [x] F166 Intel Profile × Dataset Coverage — /entities/IntelProfile + /v1/datasets; COVERED vs DARK classification; amber badge on gaps; AI assess + TTS. [2026-09-21; IntelProfileDatasetCoverage.jsx; mounted App.jsx; build ✓]
