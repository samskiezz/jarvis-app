...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-20] Extended CommandPalette.jsx with 31 live-data panel commands (jarvis:ask dispatch) alongside existing scene + page navigation; build verified.
