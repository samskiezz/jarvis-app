...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-19: CommandPalette.jsx mounted in App.jsx; wires page registry + 10 cinematic scenes; ⌘K/Ctrl+K opens; build verified]
