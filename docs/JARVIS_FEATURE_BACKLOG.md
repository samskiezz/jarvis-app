...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-22: CommandPalette.jsx wired in App.jsx; lists all pageRegistry pages + 10 cinematic scenes; ⌘K/Ctrl+K opens, arrows/Enter navigate, Esc closes; build verified.]
