...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-16] Verified: src/components/cinematic/CommandPalette.jsx — ⌘K toggle, pages + scenes searchable, Enter navigates; build passes.
