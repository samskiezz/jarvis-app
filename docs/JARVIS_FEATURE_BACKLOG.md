...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-17: CommandPalette.jsx — ⌘K/Ctrl+K; searches cinematic scenes + all APEX pages; keyboard-navigable; mounted in App.jsx)
