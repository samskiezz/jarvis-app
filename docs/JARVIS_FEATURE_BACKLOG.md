...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-08-22] CommandPalette.jsx wired in App.jsx; searches all PAGES + 10 cinematic scenes; ↑↓/↵/Esc nav; build verified clean.
