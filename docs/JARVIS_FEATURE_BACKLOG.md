...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-08-24: pre-existing CommandPalette.jsx verified compiled + mounted in App.jsx; SkillGapAdvisor F46 wired in this run)
