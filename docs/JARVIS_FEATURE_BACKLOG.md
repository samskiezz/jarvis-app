...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-20: verified — src/components/cinematic/CommandPalette.jsx mounted in App.jsx; lists 10 cinematic scenes + all APEX pages; arrow-key nav + Enter runs + Escape closes; build passes)
