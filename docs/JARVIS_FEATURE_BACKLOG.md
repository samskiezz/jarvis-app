...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-20] CommandPalette.jsx wired in App.jsx; lists all PAGES + 10 cinematic scenes; ↑↓/↵/ESC; build verified.
