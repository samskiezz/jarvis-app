...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-04: CommandPalette.jsx — searches all pages + 10 cinematic scenes; ↑↓+Enter+Esc; mounted in App.jsx; build green (139 assets)]
