...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-08-26: mounted JarvisCommandPalette — 10 scenes + 30 live-panel commands + ask JARVIS; CommandPalette scoped to /apex only to prevent conflict)
