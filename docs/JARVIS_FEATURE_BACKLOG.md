...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-13: CommandPalette.jsx implemented and mounted in App.jsx; builds clean, 139 assets generated)
