...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-20] Component src/components/cinematic/CommandPalette.jsx verified complete: Ctrl+K/⌘K opens, filters all JARVIS pages + 10 cinematic scenes, arrow-key navigation, Enter navigates — mounted in App.jsx; build compiles clean.
