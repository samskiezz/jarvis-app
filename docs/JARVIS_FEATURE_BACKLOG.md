...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-20] CommandPalette.jsx wired in App.jsx; lists all APEX pages + 10 cinematic scenes; build verified clean.
