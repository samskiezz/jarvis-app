...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-19: JarvisCommandPalette (scenes+panels+AI fallback) wired into App.jsx replacing simpler stub]
