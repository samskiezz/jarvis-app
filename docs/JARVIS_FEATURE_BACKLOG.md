...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-08-24: CommandPalette.jsx implemented, ⌘K/Ctrl+K opens palette listing all JARVIS pages + 10 cinematic scenes, mounted in App.jsx, build verified]
