...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-09-19: CommandPalette.jsx mounted in App.jsx covers all JARVIS pages + 10 cinematic scenes; ShowMeNavigation wired into JarvisBrain for "show me X" panel routing]
