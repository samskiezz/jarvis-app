...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. [2026-08-25] Already implemented: CommandPalette.jsx (pages+scenes) + JarvisCommandPalette.jsx (scenes+panels+agent ask) both exist; CommandPalette mounted in App.jsx; build verified clean.
