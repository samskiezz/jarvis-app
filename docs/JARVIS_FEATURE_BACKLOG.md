...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-12: wired JarvisCommandPalette into App.jsx — 10 scenes + 31 live panels + agent fallback; replaces stub CommandPalette)
