...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-23: CommandPalette.jsx verified built + mounted in App.jsx; ⌘K/Ctrl+K opens palette, ArrowUp/Down navigates, Enter runs, Esc closes; lists all 10 cinematic scenes + all APEX pages)
