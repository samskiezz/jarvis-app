...
- [x] F01 ⌘K command palette — searchable list of every JARVIS command; Enter runs it. (2026-09-12: src/components/cinematic/CommandPalette.jsx; searches all 10 cinematic scenes + APEX pages; arrow-key nav + Enter to go; mounted in App.jsx; build verified)
