...
import { isCdrmatQuery, buildCdrmatScript } from "./ContactDatasetRiskMatrix";
...
import { isIrsnexQuery, buildIrsnexScript } from "./InvestmentRiskScenarioNexus";
import { isTskquadQuery, buildTskquadScript } from "./TaskPriorityQuadrant";
import { isOaivcorrQuery, buildOaivcorrScript } from "./OpsAlertInvestigationBoard";
...
import { isRdknexQuery, buildRdknexScript } from "./ReportDatasetKnowledgeNexus";
...
import { isTdrnexQuery, buildTdrnexScript } from "./TaskDatasetReportNexus";
import { isAspknexQuery, buildAspknexScript } from "./OpsAlertScenarioKnowledgeNexus";
import { isKcsbriefQuery, buildKcsbriefScript } from "./KnowledgeContactScenarioBrief";
import { isRctownxQuery, buildRctownxScript } from "./ReportContactTaskOwnership";
import { isDcslnexQuery, buildDcslnexScript } from "./DatasetContactSkillNexus";
import { isRksmQuery, buildRksmScript } from "./RiskSignalKnowledgeSkillMitigation";
...
import { isSskicovQuery, buildSskicovScript } from "./SwarmScenarioKnowledgeCoverage";
import { isIpgcnexQuery, buildIpgcnexScript } from "./IntelProfileGraphNexus";
...
export default function JarvisBrain() {
  ...
  async function ask(rawQ) {
    ...
    try {
      ...
      } else if (isCdrmatQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:cdrmat-toggle"));
        answer = await buildCdrmatScript();
      ...
      } else if (isIpstinexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:ipstinex-toggle"));
        answer = await buildIpstinexScript();
      ...
      } else if (isIrsnexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:irsnex-toggle"));
        answer = await buildIrsnexScript();
      } else if (isTskquadQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:tskquad-toggle"));
        answer = await buildTskquadScript();
      } else if (isOaivcorrQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:oaivcorr-toggle"));
        answer = await buildOaivcorrScript();
      } else if (isKfreshQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:kfresh-toggle"));
        answer = await buildKfreshScript();
      ...
      } else if (isRskrnexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:rskrnex-toggle"));
        answer = await buildRskrnexScript();
      ...
      } else if (isOpevQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:opev-toggle"));
        answer = await buildOpevScript();
      ...
      } else if (isRdknexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:rdknex-toggle"));
        answer = await buildRdknexScript();
      } else if (isSrscapQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:srscap-toggle"));
        answer = await buildSrscapScript();
      } else if (isIcdbrgQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:icdbrg-toggle"));
        answer = await buildIcdbrgScript();
      ...
      } else if (isSrtnexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:srtnex-toggle"));
        answer = await buildSrtnexScript();
      ...
      } else if (isTdrnexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:tdrnex-toggle"));
        answer = await buildTdrnexScript();
      } else if (isAspknexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:aspknex-toggle"));
        answer = await buildAspknexScript();
      } else if (isKcsbriefQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:kcsbrief-toggle"));
        answer = await buildKcsbriefScript();
      } else if (isRctownxQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:rctownx-toggle"));
        answer = await buildRctownxScript();
      } else if (isDcslnexQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:dcslnex-toggle"));
        answer = await buildDcslnexScript();
      } else if (isRksmQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:rksm-toggle"));
        answer = await buildRksmScript();
      } else if (isSctexcovQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:sctexcov-toggle"));
        answer = await buildSctexcovScript();
      } else if (isSjkrbakQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:sjkrbak-toggle"));
        answer = await buildSjkrbakScript();
      ...
      } else if (isIncivctyQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:incivcty-toggle"));
        answer = await buildIncivctyScript();
      ...
      } else if (isCkrcompQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:ckrcomp-toggle"));
        answer = await buildCkrcompScript();
      ...
      } else if (isPtwlistQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:ptwlist-toggle"));
        answer = await buildPtwlistScript();
      ...
      } else if (isCirdossQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:cirdoss-toggle"));
        answer = await buildCirdossScript();
      ...
      } else if (isTikcQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:tikc-toggle"));
        answer = await buildTikcScript();
      ...
      } else if (isEvlibQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:evlib-toggle"));
        answer = await buildEvlibScript();
      ...
      } else if (isIikmQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:iikm-toggle"));
        answer = await buildIikmScript();
      } else if (isTroiQuery(q)) {
        window.dispatchEvent(new CustomEvent("jarvis:troi-toggle"));
        answer = await buildTroiScript();
