...
export const PAGES = [
  ...
  { name: "UnderworldRender", label: "Underworld Render", icon: "🎮", group: "command",
    aliases: ["render","build","install","one-click","one click","ue5","unreal","game","cook","deploy","stream","installer"],
    component: P(() => import("@/pages/UnderworldRender")) },
  ...
  { name: "Setup", label: "Setup / Install", icon: "⚡", group: "jarvis", home: true,
    aliases: ["setup","install","initialise","initialize","power on","first run","llm"],
    component: P(() => import("@/pages/Setup")) },
  ...
  { name: "AutoConsole", label: "Auto Console", icon: "⊞", group: "jarvis",
    aliases: ["auto","self building","windows","generated ui","dynamic"],
    component: P(() => import("@/pages/AutoConsole")) },
  { name: "Photos", label: "Photos", icon: "🖼", group: "jarvis",
    aliases: ["photo","gallery","slideshow","images","pictures","frame"],
    component: P(() => import("@/pages/Photos")) },
  { name: "WorkshopKit", label: "Workshop Kit", icon: "🧩", group: "foundry",
    aliases: ["workshop","widgets","gantt","comments","feature audit","palantir"],
    component: P(() => import("@/pages/WorkshopKit")) },
  ...
  { name: "PipelineMonitor", label: "Pipeline Monitor", icon: "⛓", group: "foundry",
  ...
  { name: "OntologyManager", label: "Ontology Manager", icon: "🗃️", group: "foundry",
  ...
  { name: "GraphOps", label: "Graph Ops", icon: "🕸️", group: "gotham",
  ...
  { name: "ObjectExplorer", label: "Object Explorer", icon: "📊", group: "foundry",
  ...
  { name: "ObjectSets", label: "Object Sets", icon: "📦", group: "foundry",
  ...
  { name: "LineageGraph", label: "Lineage", icon: "🧬", group: "foundry",
