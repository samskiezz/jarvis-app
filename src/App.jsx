      ...
      <QueryClientProvider client={queryClientInstance}>
        <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <AuthGate>
            ...
            {/* F46 (overnight 2026-08-07): skill gap advisor — ◈ GAPS button (left:3508, bottom:8, zIndex:60); fetches /v1/aip/skill; sorts by score to surface bottom-3 weakest skills; generates AI training recommendations for each via /v1/jarvis/agent/chat; score bars + urgency labels (CRITICAL GAP/NEEDS WORK/DEVELOPING); badge on count of skills below 70; 5-min auto-refresh; "skill gap"/"training plan"/"learning plan"/"how do I improve"/"weakest skill"/"capability gap"/"upskill" voice trigger; jarvis:skillgap-toggle event */}
            <SkillGapAdvisor />
