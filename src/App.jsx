      ...
      <QueryClientProvider client={queryClientInstance}>
        <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          <AuthGate>
            ...
            {/* F46 (overnight 2026-08-24): skill gap advisor — ◈ SKLGAP button; fetches /v1/aip/skill, identifies lowest-scoring skills, sends each to /v1/jarvis/agent/chat for AI training recommendations; "skill gap"/"training plan"/"how do I improve"/"learning plan" voice trigger */}
            <SkillGapAdvisor />
